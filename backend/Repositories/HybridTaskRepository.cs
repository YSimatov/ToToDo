...
public class HybridTaskRepository : ITaskRepository
{
  ...
  public void Delete(string id)
  {
    ...
    {
      // If ID is invalid, we can't really delete anything. 
      // Throwing exception or returning is a design choice.
      // Given void return, let's throw or just return.
      // Usually repositories shouldn't silently fail, but for "Delete" if ID is bad...
